...
<div id="baza-noclegowa" class="baza-noclegowa single-event-dbs">
	<div class="row">
	<?php
		$baza_noclegowa_baner = get_field('baza_noclegow_baner');
		...
		<div class="col-xs-11 col-xs-offset-1 col-sm-6 col-sm-offset-0 col-md-6 col-md-offset-0 bottom-align-text">
			<h3 class="tungsten-semibold niezbednik__title"><?php _e( 'baza noclegowa', 'biuro-literackie' ); ?></h3>
		</div>
	</div>
	
	<?php
		// loop through the rows of data
		while ( have_rows('miejsca_noclegowa') ) : the_row(); 
