...
if ( $kl_query->have_posts() ) : ?>
<a class="lato-font" data-toggle="collapse" data-target="#bibliografia"><?php _e( 'bibliografia', 'biblioteka' ); ?></a>
<div id="bibliografia" class="col-xs-12 playfair-display collapse in">
    <?php // AUTOR
    ...
    <ul class="bibliografia">
        ...
        <li class="playfair-display">
            ...
            <div>
                ...
                <?php if ( strpos(get_field('wydawca'), 'Biuro Literackie') !== false ) : ?>
