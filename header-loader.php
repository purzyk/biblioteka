...
<div id="page" class="hfeed site">
    ...
    <div id="preloader"> 
  <div id="status">
  <img src="https://www.biuroliterackie.pl/biblioteka/wp-content/themes/biblioteka/img/BLWWW_2012_czern_resize.jpg" class="pulse">
  </div> 
</div>
...
<?php
if ( is_post_type_archive('biuletyn') ) {
    ?>
